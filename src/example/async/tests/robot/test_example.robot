...
#
#  $ bin/test -s example.async -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src example.async.testing.EXAMPLE_ASYNC_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/example/async/tests/robot/test_example.robot
#
